...
with DAG(
    ...
    env_id = "test"
    s3_bucket_source: str = f"{env_id}-datasync-bucket-source"
    s3_bucket_destination: str = f"{env_id}-datasync-bucket-destination"
    ...
    source_location = create_source_location(s3_bucket_source, "test")
    destination_location = create_destination_location(s3_bucket_destination, "test")
