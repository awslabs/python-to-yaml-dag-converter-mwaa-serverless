...
with DAG(
    ...
    test_context = {
        ROLE_ARN_KEY: "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
        SUBNETS_KEY: "subnet-12345678901234567",
        SECURITY_GROUPS_KEY: "sg-12345678901234567,sg-12345678901234568",
    }
    env_id = "test"
